...
# === SEKCJA SCIEZEK ===
# Folder projektu
$projectFolder = Join-Path -Path $basePath -ChildPath "Postman_API_TestAutomation\ReceiptCorrectionCreation"
$logFolder = Join-Path -Path $projectFolder -ChildPath "user_logs"
# Sciezki do nowych plików
$collectionPath = Join-Path -Path $projectFolder -ChildPath "AAT_ReceiptCorrection.postman_collection.json"
$environmentPath = Join-Path -Path $projectFolder -ChildPath "ReceiptCorrectionCreation.postman_environment.json"
$dataPath = Join-Path -Path $projectFolder -ChildPath "TD_AAT_ReceiptCorrection.json"
# === KONIEC SEKCJI ===
