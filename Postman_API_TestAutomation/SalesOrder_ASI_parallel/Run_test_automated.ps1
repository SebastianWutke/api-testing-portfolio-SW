...
# === SEKCJA SCIEZEK ===
# Folder projektu
$projectFolder = Join-Path -Path $basePath -ChildPath "Postman_API_TestAutomation\SalesOrder_ASI_parallel"
$logFolder = Join-Path -Path $projectFolder -ChildPath "user_logs"
$collectionPath = Join-Path -Path $projectFolder -ChildPath "AAT_SO_ASI_parallel.postman_collection.json"
$environmentPath = Join-Path -Path $projectFolder -ChildPath "AAT_SO_ASI.postman_environment.json"
$dataPath = Join-Path -Path $projectFolder -ChildPath "TD_AAT_SalesOrder_Parallel.json"
